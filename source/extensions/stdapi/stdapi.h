...
#define TLV_TYPE_HANDLE_IN					MAKE_CUSTOM_TLV(TLV_META_TYPE_UINT, TLV_TYPE_EXTENSION_STDAPI, 602)
#define TLV_TYPE_HANDLE_OUT					MAKE_CUSTOM_TLV(TLV_META_TYPE_UINT, TLV_TYPE_EXTENSION_STDAPI, 603)
